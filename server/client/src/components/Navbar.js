        ...
        if (state) { //state will be populated with user details on USER action, else it will be initialState null
            return (
                <>
                    ...
                    <li><Link to="/createstory"><i className="small material-icons navbar-icons">add_to_photos</i></Link></li>
                    <li><Link to="/chatrooms"><i className="small material-icons navbar-icons">forum</i></Link></li>
                    <li><Link to="/followSuggestion"><i className="small material-icons navbar-icons">person_add</i></Link></li>
        ...
        if (state) {
            return (
                <>
                    ...
                    <li className="sidenav-close"><Link to="/createstory">Create Story</Link></li>
                    <li className="sidenav-close"><Link to="/chatrooms">Chatrooms</Link></li>
                    <li className="sidenav-close"><Link to="/followSuggestion">Follow Suggestion</Link></li>
