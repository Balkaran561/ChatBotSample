            ...
            {data ?
                ...
                <div className="card home-card" key={data._id}>
                    <div className="card-content">
                        ...
                        <p className="grey-text" style={{ paddingBottom: "13px", fontSize: "0.8em", textTransform: "uppercase" }}>
                        <i class="material-icons" style={{ fontSize: "1.2em", verticalAlign: "text-bottom", paddingRight: "5px" }}>access_time</i>
