        ...
        if (state) {
            fetch(`/post/${postId}`, {
                ...
                .then(result => {
                    ...
                    setLocation(result.post.location);
                ...
                pageLoading ?
                    ...
                    <div className="card input-field"
                        ...
                        <GooglePlacesAutocomplete
                            selectProps={{
                                defaultInputValue:location&&location.label&&location.label,
                                ...
                                images.length === 0 ? <img className="upload-img" src="https://www.worldloppet.com/wp-content/uploads/2018/10/no-img-placeholder.png" />
                                    ...
                                    images.map((im, i) =>
                                        im instanceof File ?
                                            ...
                                            :
                                            //for url name type or taken photo
                                            im.substring(im.lastIndexOf('.') + 1, im.length).match(/(jpg|jpeg|png|gif)$/i) || im.substring(im.indexOf(':')+1,(im.indexOf('/')))==="image" ?
                                                <div key={i} style={{ position: "relative" }}>
                                                    <img className="upload-img"
