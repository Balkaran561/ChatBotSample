...
import AddHighlightStory from './components/screens/AddHighlightStory';
import FollowSuggestion from './components/screens/FollowSuggestion';
...
const Routing = () => {
  ...
  return (
    <Switch>
      ...
      <Route path="/editstory/:storyId">
        <EditStory/>
      </Route>
      <Route path="/addHighlightStory">
        <AddHighlightStory/>
      </Route>
      <Route path="/followSuggestion">
        <FollowSuggestion/>
      </Route>
    </Switch>
  )
